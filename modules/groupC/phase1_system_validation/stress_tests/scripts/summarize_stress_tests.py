...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--stress-results-dir", default="../results/stress_test_outputs/stress_results", help="Directory containing validation_metrics.py outputs.")
    ap.add_argument("--out-stress", default="../results/stress_test_outputs/stress_test_results.tsv", help="Output TSV for quantitative stress-test summary.")
    ap.add_argument("--out-technical", default="../results/stress_test_outputs/technical_check_results.tsv", help="Output TSV for technical/contamination check summary.")
    ap.add_argument("--out-report", default="../results/stress_test_outputs/stress_test_report.md", help="Output Markdown report.")
