...
Welcome to the AGB class project!

Each of the subfolders in the workflow folder contain the main nextflow scripts of each group, which are called from the main.nf file. 

Additional subworkflows are contained in the subworkflows folder.
